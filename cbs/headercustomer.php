    ...
    <div>
        <nav class="navbar navbar-light navbar-expand-md navbar-fixed-top navigation-clean-button"
            ...
            <div class="container">
                ...
                <div><a class="navbar-brand" href="customerbooking.php"><span
                            style="color: rgb(215,109,11);">Careta</span></a></div>
                <div class="collapse navbar-collapse" id="navcol-1" style="color: rgb(255,255,255);">
                    <ul class="navbar-nav nav-right">
                        <li class="nav-item"><a class="nav-link" href="customerprofile.php"
                                style="color: rgba(224,217,217,0.9);">Profile</a></li>
                        <li class="nav-item"><a class="nav-link" href="customerbooking.php"
                                style="color: rgba(224,217,217,0.9);">Book</a></li>
                        <li class="nav-item"><a class="nav-link" href="customermanage.php"
                                style="color: rgba(224,217,217,0.9);">Manage</a></li>
                    </ul>
